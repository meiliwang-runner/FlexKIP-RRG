...
# ========================= SIP Dataset Settings ==========================
parser.add_argument('--use_sip', type=lambda x: str(x).lower() == 'true', default=False, help='Whether to use SIPPromptModule (True or False)')
parser.add_argument('--region_root', type=str, default=None, help='Path to .pt region file folder')
parser.add_argument('--patch_size', type=int, default=40, help='Patch size used in region feature')
# parser.add_argument('--input_size', type=int, default=224, help='Image input size for vision backbone')
